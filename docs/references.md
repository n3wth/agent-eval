...
- **BEAM, "Beyond a Million Tokens" (2025–2026 preprint, verify venue).** Includes preference following, knowledge update, abstention, and contradiction resolution, the categories closest to correction-stickiness and over-remembering. **Limitation:** new, synthetic at extreme scale.
